...
2. **грид**, двумерная сетка из рядов и колонок в [грид-раскладке](https://github.com/web-standards-ru/dictionary/blob/master/Dictionary.md#grid-layout).

### **grid layout**
**грид-раскладка,** механизм [раскладки](https://github.com/web-standards-ru/dictionary/blob/master/Dictionary.md#layout), позволяющий располагать элементы по двумерной сетке — [гриду](https://github.com/web-standards-ru/dictionary/blob/master/Dictionary.md#grid) (2).
...
- **grid area** — *грид-область*, логическое пространство для размещения *грид-элементов*, ограниченное четырьмя *грид-линиями*
